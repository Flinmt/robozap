...
function getDefaults() {
    return {
        ...
        includeProtocol: parseBoolean(process.env.PARTNERBOT_INCLUDE_PROTOCOL, false),
...
function normalizeConfig(input) {
    ...
    return {
        ...
        includeProtocol: parseBoolean(merged.includeProtocol, defaults.includeProtocol),
